...
class UnrealBloomPass extends Pass {
  private static BlurDirectionX = new Vector2(1.0, 0.0)
  private static BlurDirectionY = new Vector2(0.0, 1.0)
  ...
  public renderTargetBright: WebGLRenderTarget
  ...
  private basic: MeshBasicMaterial

  private fsQuad: FullScreenQuad

  public scene: Scene
  public camera: Camera
  public context: WebGLAppContext

  constructor(resolution: Vector2, strength: number, radius: number, context: WebGLAppContext) {
    super()
